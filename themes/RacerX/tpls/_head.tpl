...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{sugar_getjspath file='custom/include/css/customStyles.css'}"/>
    ...
    {sugar_getscript file="custom/modules/C_FieldHighlighter/js/FieldHighlighterHandler.js"}

    {sugar_getscript file="modules/Notifications/tpls/notifications.js"}
    {sugar_getscript file="custom/modules/C_HelpTextConfig/js/HelpTextConfigHandler.js"}
    ...
    {/literal}
    {sugar_getscript file="themes/RacerX/js/utils.js"}
