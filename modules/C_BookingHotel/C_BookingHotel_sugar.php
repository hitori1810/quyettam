<?PHP
    ...
    * PLACE ANY CUSTOMIZATIONS IN C_BookingHotel
    */


    class C_BookingHotel_sugar extends Basic {
        var $new_schema = true;
        var $module_dir = 'C_BookingHotel';
        var $object_name = 'C_BookingHotel';
        var $table_name = 'c_bookinghotel';
        var $importable = true;
        var $id;
        var $name;
        var $date_entered;
        ...
        var $dateline;
        var $booking_name;
        var $hotel_booking_code;
        var $booking_date;
        var $check_in_date;
        var $check_out_date;
        var $invoice_no;
        var $invoice_serial_no;
        var $invoice_date;
        var $prepay_amount;
        var $currency_id;
        var $total_amount;
