    ...
    return {
        ...
        saveDisplayColumns: function() {
            ...
            for (var i = 1; i < table.rows.length; i++) {
                ...
                if(cells[3].getElementsByTagName('input').length >0){ // add by Hai Nguyen
        ...
        saveDisplaySummaries: function() {
            ...
            for (var i = 1; i < table.rows.length; i++) {
                ...
                //if ((report_type == 'summation' && cells[3].getElementsByTagName('input')[0].checked) { // remove by Hai Nguyen
                if ((report_type == 'summation' || report_type == 'summation_with_details') && cells[3].getElementsByTagName('input')[0].checked) {  // Custom By Hai Nguyen To Sort Summary with Detail Report
                    sortedOn = true;
        ...
        prepareReportForProcessing: function() {
            ...
            // if (summary_order_by.length > 0 && report_type == 'summation')  // Remove By Hai Nguyen 
            if (summary_order_by.length > 0 && (report_type == 'summation' || report_type == 'summation_with_details'))  /* Add By Hai Nguyen */
        ...
        addFieldToDisplaySummaries: function(e, linkedGroupById) {
            ...
            cell.setAttribute('scope', 'row');
            //if (report_type == 'summation') {    // Remove By Hai Nguyen 
            if (report_type == 'summation' || report_type =='summation_with_details' /*Add By Hai Nguyen */) {
        ...
        addFieldToDisplayColumns: function(e) {
            ...
            cell = row.insertCell(3);
            if(report_type == 'tabular')
                cell.innerHTML = "<input type='radio' title='" + SUGAR.language.get('Reports', 'LBL_ORDER_BY') + "' name='order_by_radio' id='order_by_radio_" + totalDisplayColRows + "' onClick='SUGAR.reports.orderBySelected(" + totalDisplayColRows + ")'></input>"; // Remove By Hai Nguyen Prevent Order By Summary With Detail
        ...
        addFieldToDisplaySummariesOnLoad: function(summaryColumn, linkedGroupById, summaryOrderBy) {
            ...
            if (report_type == 'summation' || report_type =='summation_with_details' /* Add By Hai Nguyen */) {
                ...
                if (typeof(summaryOrderBy) != "undefined" && summaryOrderBy.length > 0) {
                    //if (report_type == 'summation' && summaryOrderBy[0].name == summaryColumn.name && summaryOrderBy[0].table_key == summaryColumn.table_key) { // Remove By Hai Nguyen
                    if ((report_type == 'summation' || report_type =='summation_with_details' /* Add By Hai Nguyen */) && summaryOrderBy[0].name == summaryColumn.name && summaryOrderBy[0].table_key == summaryColumn.table_key) {
