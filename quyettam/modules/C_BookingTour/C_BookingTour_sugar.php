<?PHP
    ...
    * PLACE ANY CUSTOMIZATIONS IN C_BookingTour
    */


    class C_BookingTour_sugar extends Basic {
        var $new_schema = true;
        var $module_dir = 'C_BookingTour';
        var $object_name = 'C_BookingTour';
        var $table_name = 'c_bookingtour';
        var $importable = true;
        var $id;
        var $name;
        var $date_entered;
