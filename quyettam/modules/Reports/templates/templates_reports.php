...
EOD
    ...
    if(ACLController::checkAccess($reporter->module, 'export', true)){
...
EOD
            ...
            $buttons[] = <<<EOD
        <input type="button" class="button" name="exportToExcel" id="exportToExcel" value="Export Excel" title="Export to Excel"  onclick="exportExcel();return;">
EOD;
        }    
    }
