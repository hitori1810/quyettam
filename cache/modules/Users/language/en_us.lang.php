...
<tr><td><!--not_in_theme!--><img src=include/images/forums.png style="margin-right: 5px;"></td><td><a href="http://www.sugarcrm.com/forums" target="_blank"><b>Forums</b></a><br>Forums dedicated to the Sugar Community to discuss topics of interest with each other and with SugarCRM Developers</td></tr>
  ...
  'LBL_SHOWCLICKTOCALL' => 'Show dial icon for calling',
  'LBL_PHONEEXTENSION' => 'Asterisk Extension',
  'LBL_ASTERISK' => 'Asterisk IP',
  'LBL_DIALOUTPREFIX' => 'Channel',
  'LBL_DIALPLAN' => 'Context',
  'LBL_CALL_NOTIFICATION' => 'Need Notification',
  'LBL_RELATE_CONTACT' => 'Relate Contact',
  'LBL_RELATE_ACCOUNT' => 'Relate Account',
  'LBL_CREATE_ACCOUNT' => 'Create Account',
  'LBL_OPEN_ACCOUNT' => 'Open Account',
  'LBL_CREATE_CONTACT' => 'Create Contact',
  'LBL_OPEN_CONTACT' => 'Open Contact',
  'LBL_CREATE_LEAD' => 'Create Lead',
  'LBL_OPEN_LEAD' => 'Open Lead',
  'LBL_CALLTRANSFER' => 'Call Transfer',
  'LBL_CALLHOLD' => 'Call Hold',
  'LBL_CALLHANGUP' => 'Call Hangup',
  'LBL_LAST_CALL' => 'Show Previous Call',
  'LBL_CTIUSER_PANEL' => 'Asterisk User Configuration Panel',
  'LBL_SCHEDULECALL' => 'Call Schedule',
  'LBL_TASKCALL' => 'Create Task',
  'LBL_CREATE_CASE' => 'Create Case',
  'LBL_BC_SURVEY_SUBMISSION_USERS_FROM_BC_SURVEY_SUBMISSION_TITLE' => 'Survey Submission',
  'LBL_BC_SURVEY_USERS_FROM_BC_SURVEY_TITLE' => 'Survey',
  'LBL_PROJECT_USERS_1_FROM_PROJECT_TITLE' => 'Projects',
  'LBL_PROJECT_USERS_1_FROM_USERS_TITLE_ID' => 'Projects ID',
  'LBL_USERS_OPPORTUNITIES_1_FROM_OPPORTUNITIES_TITLE' => 'New Sales',
  'LBL_USERS_J_MARKETINGPLAN_1_FROM_J_MARKETINGPLAN_TITLE' => 'Approved ',
  'LBL_USERS_J_MARKETINGPLAN_2_FROM_J_MARKETINGPLAN_TITLE' => 'Checked By',
  'LBL_USERS_J_FEEDBACK_1_FROM_J_FEEDBACK_TITLE' => 'CC User 1:',
  'LBL_USERS_J_FEEDBACK_2_FROM_J_FEEDBACK_TITLE' => 'CC User 2:',
  'LBL_HOMEPAGE_MANAGER_ONLY_ONCE' => 'Only on next login',
  'LBL_HOMEPAGE_MANAGER_MERGE' => 'Merge Homepages',
  'LBL_DEFAULT_HOMEPAGE_TEXT' => 'Which Home Page to use for this user.  You can either pick a saved configuration or to link to another users home page.',
  'LBL_DEFAULT_DASHBOARD' => 'Default Homepage',
  'LBL_HOMEPAGE_MANAGER_TEXT' => 'Which Dashboard to use for this user.  You can either pick a saved configuration or to link to another users dashboard.',
  'LBL_HOMEPAGE_MANAGER_TITLE' => 'Default Home Page Configuration',
  'LBL_SAVE_CONFIGRUATION' => 'Save a New Home Page Configuration',
  'LBL_HOMEPAGE_MANAGER_ONCE_ONLY_TEXT' => 'If this is checked then the users Home Page will be reset the next time they log in; but not after that',
  'LBL_HOMEPAGE_MANAGER_MERGE_TEXT' => 'If this is checked then the users Home Page merged with the above Home Page.  This allows you to set a "minimum" set of dashlets for users.  They will be able to add dashlets but not get rid of this set.',
  'LBL_SAVE_TEXT' => 'This will save this users current Home Page configuration.  You will then be able to assign that configuration to other users.  You will be able to change this users Home Page without affecting the saved copy.',
  'LBL_PERSONAL_TEAM' => 'Private Team',
  'LBL_LINK_TO' => 'Link To:',
  'LBL_NONE' => 'None',
  'LBL_SAVED_TEMPLATES' => 'Saved Templates',
  'LBL_USER_TEMPLATES' => 'User Templates',
  'LBL_HOMEPAGE_OPTIONS' => 'Homepage Options',
  'LBL_LOCK_HOMEPAGE_TEXT' => 'This allows you to lock homepages on a user by user basis.<br><br>The first option in the standard lock option and prevents users from changing their homepage at all, this option is just a finer grained control that SugarCRM already has, it just makes it so that you can lock individual users instead of everyone.<br><br>The second option allows change but on login those changes will be rolled back to their default template so any changes made to \\"stock\\" tabs will be lost and any new tabs they created will remain.<br><br>The third option is the same as the second except that it allows your users to delete stock tabs without having them added back after the next login',
);