<?php /* Smarty version 2.6.11, created on 2018-03-27 23:02:59
         compiled from modules/C_ConfigID/tpls/index.tpl */ ?>
<html>
    <head> 
            ...
            <form name="configinfo" id="configinfo"> 
                <table width="100%" class="table-list" border="0" cellpadding="4" cellspacing="0">
                    ...
                    <tr>
                        ...
                        <td><select name = "module_name" id="module_name"><?php echo $this->_tpl_vars['select_module']; ?>
</select></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td>Date Format</td>
                        <td><select name = "date_format" id = "date_format"><?php echo $this->_tpl_vars['select_date_format']; ?>
</select><br><br>
