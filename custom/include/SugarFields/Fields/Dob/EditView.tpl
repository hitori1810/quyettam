...
<input type="text" name="{{$year}}" id="{{$year}}" style="width:50px;vertical-align: top;" maxlength='4' value='{$fields.{{$year}}.value}'  {{if !empty($tabindex)}} tabindex="{{$tabindex}}" {{/if}}><span class="dateFormat"> dd mm yyyy</span>
