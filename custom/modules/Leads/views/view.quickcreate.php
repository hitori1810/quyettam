    ...
    class LeadsViewQuickcreate extends ViewQuickcreate{
        public function preDisplay() {
            ...
            if($this->_isDCForm) {
                ...
                if(!empty($this->bean->billing_address_district))$_REQUEST['primary_address_district'] = $this->bean->billing_address_district;
            }
        }
        ...
        function display(){
            ...
            * End Address Field
            * 
            * @var ContactsViewEdit
            */
            parent::display();
            echo '<script type="text/javascript" src="custom/modules/Leads/javascript/EditView.js"></script>';
            echo '<script type="text/javascript" src="custom/include/javascripts/autoLoadOption.js"></script>';            
        }    
    }
?>