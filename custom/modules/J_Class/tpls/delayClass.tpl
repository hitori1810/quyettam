<div id="delay_class_dialog" title="Delay Class" style="display:none;">
        ...
        <br> Lịch học của lớp: <span id='dl_schedule'>{$SCHEDULE}</span><br>
        <b>Bước 1:</b> Chọn khoảng thời gian delay<br><br>
        Delay từ:<span style="color:red;">*</span>
        ...
        Delay đến:<span style="color:red;">*</span>
