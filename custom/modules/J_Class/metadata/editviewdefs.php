        ...
        array (
            ...
            array (
                ...
                array (
                    ...
                    array (
                        ...
                        <input type="hidden" id="class_type_adult" name="class_type_adult" value="{$fields.class_type_adult.value}">
                        {else}
                        {html_options name="class_type_adult" id="class_type_adult" options=$class_type_adult selected=$fields.class_type_adult.value}
                        {/if}
                        {else}
                        <label id="class_type_label">{$fields.class_type.value}</label>
                        {/if}
                        ',
                ...
                array (
                    0 => array(
                        ...
                        'customCode' =>'
                        <input type="button" style="display:none;" name="btn_edit_schedule" class="button primary" id="btn_edit_schedule" value="Change Schedule" />
                        {if $is_lock_date == "1"}
                        <input type="button" style="display:none;" name="btn_edit_schedule" class="button" id="btn_edit_startdate" value="Change Start Date" />
                        {/if}
                        ...
                        <label id="change_date_to_label" width="12.5%" style="background-color:#eee; color: #444; padding:.6em;display:none;">Change To Date:<span class="required">*</span></label>&nbsp;
                ...
                array (
                    ...
                    1 => array(
                        ...
                        {html_options name="period" options=$fields.period.options selected=$fields.period.value}
                        {/if}',
                    ),
                ),
            ),
            'LBL_EDITVIEW_PANEL4' => array (
                ...
                array (
                    ...
                    array (
                        'name' => 'class_type',
                        'customCode' => '<label id="class_type_label">{$fields.class_type.value}</label>',
                    ),
