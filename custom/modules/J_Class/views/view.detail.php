    ...
    */
    public function display()
    {
        ...
        if($this->bean->status == "Planning" && (checkDataLockDate($situationDate))){
            $btnSubmitInProgress = '<button type="button" class="button" id="submit_in_progress" name="submit_in_progress" value="'.$GLOBALS['mod_strings']['LBL_SUBMIT_IN_PROGRESS'].'"> <span style="color: #115CAB;font-weight: bold;">'.$GLOBALS['mod_strings']['LBL_SUBMIT_IN_PROGRESS'].'</span></button>';
        }
