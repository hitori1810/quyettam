    ...
    public function display(){
        ...
        if (empty($this->bean->content)){
            ...
            foreach($content as $key => $value){
                ...
                $ssLevelItem->assign("JSON", json_encode($value , JSON_UNESCAPED_UNICODE));
        ...
        if (empty($this->bean->syllabus))
            ...
            foreach($sylls as $key => $syl)
                $sylItems .= getSyllabusRow($syl['lesson'],$syl['content'],json_encode($syl,JSON_UNESCAPED_UNICODE),false);
