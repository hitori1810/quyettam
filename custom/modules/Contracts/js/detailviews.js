    ...
    $.ajax({
        ...
        success:function(data){
            ...
            if (data.success == "1") {
                ...
                alertify.error('An error occurred. <br><br>Please, check again!')
            }
        },
        error: function(xhr, textStatus, errorThrown){
            ajaxStatus.hideStatus();
...
function cancel_invoice(payment_detail){
    // prompt dialog
    alertify.prompt('Are you sure you want to cancel this invoice?', function (e, str) {
            ...
            $.ajax({
                ...
                success:function(data){
                    ...
                    if (data.success == "1") {
                        ...
                        alertify.error('This payment has been used. You can not cancel!');
                    }
                    ajaxStatus.hideStatus();
                },
            });
