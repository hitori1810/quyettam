    ...
    <table class="list view" id="diagnosis_list">
        <thead>
            <tr class="row" style="margin-left: 5px;margin-top: 10px;">
                ...
                <td colspan="6"> Time Range: <input type="text" onkeyup="checkTimeRange()" id="time_range" name="time_range" value="{$time_range}" style="width: 30px;text-align: right;">  Minutes</td>
