...
class ListviewLogicHookMeetings {
    ...
    function listviewcolor_Meetings(&$bean, $event, $arguments) {
        ...
        elseif($bean->meeting_type == 'Session'){
            $bean->syllabus_custom = '<table width="100%" style="padding:0px!important;"><tbody><tr><td style="padding: 0px !important;"><input type="text" meeting_id = "'.$bean->id.'" class = "syllabus_custom" name="syllabus_custom" style="position: relative;" size="30" value="'.$bean->syllabus_custom.'" title="'.translate('LBL_SYLLABUS_CUSTOM').'"></td>';
            $bean->syllabus_custom .= "</tr></tbody></table>";
            $bean->homework = '<table width="100%" style="padding:0px!important;"><tbody><tr><td style="padding: 0px !important;"><input type="text" meeting_id = "'.$bean->id.'" class = "homework" name="homework" style="position: relative;" size="30" value="'.$bean->homework.'" title="'.translate('LBL_HOMEWORK').'"></td>';
