...
//        }
        ...
        if($this->bean->meeting_type == "Session" && !empty($this->bean->id)){
            ...
            //$check_date = $date_time_object->setDate($date_time_object->year, $date_time_object->month + 1, 4);
            //
            //                $check_date = strtotime($check_date);
            //
            //                $now = strtotime($GLOBALS['timedate']->nowDb());
            //                if( $now > $check_date && ACLController::checkAccess('C_Classes', 'edit', true)){
            //                    echo '
