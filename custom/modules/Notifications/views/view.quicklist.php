        ...
        function _formatNotificationsForQuickDisplay($notifications, $tplFile){
            ...
            if(count($data3)>0){
                ...
                for($i = 0; $i<count($data3);$i++){
                    $html .=  "<tr> <td><a  href='index.php?module=".$data3[$i]['module_name']."&action=DetailView&record=".$data3[$i]['id']."' >".$data3[$i]['NAME']."</a></td><td>".translate('LBL_MODULE_NAME',$data2[$i]['module_name'])."</td></tr> ";
                } 
            }
