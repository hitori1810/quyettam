            ...
            array (
                ...
                array (
                    ...
                    array (
                        ...
                        'customCode' => '{html_options name="type_of_course_fee" id="type_of_course_fee" style="width: 100px;margin-left:10px;" options=$fields.type_of_course_fee.options selected=$fields.type_of_course_fee.value}<input type="hidden" name="type" id="type" value="{$fields.type.value}">'
                    ),
                    1 =>
                    array (
                        'name' => 'status',
