...
function exportErrorFile($csvFile, $contentArray, $importModule){
    ...
    if($importModule == "Leads") $templateUrl = "custom/uploads/TemplateImport/Template_Import_Lead.xlsx";
    ...
    // Set properties
    $objPHPExcel->getProperties()->setCreator("Atlantic CRM");
    $objPHPExcel->getProperties()->setLastModifiedBy("Atlantic CRM");
